...
const Bridal = () => {
  usePageMeta(
    ...
    "Luxury Asian bridal makeup and hair styling in Birmingham. 20% off + free facial, from £600. 50% deposit secures your date."
  );
        ...
        <div className="container">
          <div className="hero__content fade-up">
            ...
            <p className="hero__desc">
              Nadiya brings 15+ years of bridal expertise, training with renowned artists and
