        ...
        <div className="container">
          <div className="split">
            ...
            <div>
              ...
              <p>
                Led by founder and lead artist Nadiya, AS.PRO ARTIST brings over 8 years of
                professional hair and beauty expertise to Birmingham, with a special focus on
                bridal artistry.
              </p>
              <ul className="check-list">
                <li><span className="tick"><IconArrowRight width={16} height={16} /></span> 8+ years of professional experience</li>
        ...
        <div className="container">
          <div className="split split--reverse">
            <div>
              ...
              <p>
                With 8+ years of experience, I've trained with Lubna Rafiq, Naeem Khan, P. Louise
      ...
      <section className="section section--ivory">
        <div className="container">
          <SectionHeading
            ...
            goldWord="Treatments"
            subtitle="A selection from our 24 specialised facial treatments."
          />
          <div className="grid grid--4">
