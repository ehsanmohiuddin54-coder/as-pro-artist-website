...
const About = () => {
  usePageMeta(
    ...
    "Meet Nadiya, founder and lead artist of AS.PRO ARTIST — 8+ years of professional hair, beauty and bridal artistry experience in Birmingham."
  );
          ...
          <div className="grid grid--2">
            ...
            <div className="card" style={{ padding: 34 }}>
              ...
              <ul className="check-list">
                ...
                <li><span className="tick">✓</span> 8 years at {brandStory.previousSalon}</li>
