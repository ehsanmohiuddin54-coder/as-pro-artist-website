...
const MobileNav = ({ items, onClose }) => (
  <div className="mobile-nav" role="dialog" aria-modal="true" aria-label="Mobile navigation">
    ...
    <div className="mobile-nav__footer">
      <CTAButton to="/book" variant="gold" onClick={onClose}>
        Book Now
      </CTAButton>
      <CTAButton href={whatsappLink(siteInfo.whatsappMessages.general)} variant="whatsapp" icon={<IconWhatsapp width={16} height={16} />}>
        WhatsApp Us
      </CTAButton>
